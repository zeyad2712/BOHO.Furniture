        ...
        <div class="max-w-3xl mx-auto">
            ...
            <div class="mb-8 flex items-center justify-between">
                <h1 class="text-3xl font-bold" style="color: #8B4513;">
                    <i class="fas fa-edit mr-3 text-[#7b8f5a]"></i>Edit Review
                </h1>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select name="stars_count" id="stars_count"
                                ...
                                required>
                                <option value="5" {{ old('stars_count', $review->stars_count) == 5 ? 'selected' : '' }}>5
                                    Stars</option>
                                <option value="4" {{ old('stars_count', $review->stars_count) == 4 ? 'selected' : '' }}>4
                                    Stars</option>
                                <option value="3" {{ old('stars_count', $review->stars_count) == 3 ? 'selected' : '' }}>3
                                    Stars</option>
                                <option value="2" {{ old('stars_count', $review->stars_count) == 2 ? 'selected' : '' }}>2
                                    Stars</option>
                                <option value="1" {{ old('stars_count', $review->stars_count) == 1 ? 'selected' : '' }}>1 Star
                                </option>
                            </select>
                            @error('stars_count')
                                <p class="mt-2 text-sm text-red-500 font-bold font-mono italic">{{ $message }}</p>
                        ...
                        <div class="flex items-center justify-between p-4 bg-gray-50 rounded-xl border-2 border-gray-100">
                            ...
                            <label class="relative inline-flex items-center cursor-pointer">
                                ...
                                <input type="checkbox" name="is_active" value="1" class="sr-only peer" {{ old('is_active', $review->is_active) ? 'checked' : '' }}>
                                <div
