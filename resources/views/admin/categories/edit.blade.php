        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8 flex items-center justify-between">
                <h1 class="text-3xl font-bold" style="color: #8B4513;">
                    <i class="fas fa-edit mr-3 text-[#7b8f5a]"></i>Edit Category
                </h1>
                    ...
                    <div class="space-y-8">
                            ...
                            <div class="grid grid-cols-4 sm:grid-cols-6 md:grid-cols-8 gap-4 mb-4">
                                ...
                                @foreach($icons as $icon)
                                    <label class="block relative cursor-pointer group">
                                        <input type="radio" name="icon" value="{{ $icon }}" class="peer hidden" {{ $currentIcon == $icon ? 'checked' : '' }}>
                                        <div
                        ...
                        <div>
                            ...
                            <textarea name="description" id="description" rows="4"
                                ...
                                class="w-full px-6 py-4 bg-gray-50 border-2 border-gray-100 rounded-2xl focus:border-[#7b8f5a] focus:bg-white transition duration-300 outline-none">{{ old('description', $category->description) }}</textarea>
                        </div>
                        ...
                        <!-- Submit Actions -->
                        <div class="pt-6 border-t border-gray-100 flex items-center justify-end space-x-6">
                            <div class="text-left flex-1 text-xs text-gray-400 font-mono italic">
                                Last Updated:
                                {{ $category->updated_at ? $category->updated_at->format('M d, Y H:i') : 'Never' }}
                            </div>
                            <a href="{{ route('admin.categories.index') }}"
